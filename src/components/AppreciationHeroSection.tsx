...
const AppreciationHeroSection = () => {
    return (
         ...
         <div className='flex flex-col md:flex-row gap-x-10 gap-y-5 items-center'>
            ...
            <div className='w-full relative '>
                <h1 className='uppercase text-[clamp(24px,4vw,64px)]  font-semibold custom-cunia'>appreciation</h1>
                <h1 className='uppercase text-[clamp(24px,4vw,64px)]  font-semibold custom-cunia'>matters</h1>
