    ...
    return (
       <div>
         <div className='px-[clamp(20px,6vw,173px)] mt-[clamp(40px,4vw,60px)] '>
            <h1 className='uppercase text-[clamp(24px,2.5vw,57px)]  font-semibold custom-cunia' >From Virtual</h1>
            <h1 className='uppercase text-[clamp(24px,2.5vw,57px)]    font-semibold custom-cunia'>world to real Life</h1>
            <div className='flex flex-col md:flex-row md:gap-x-10 md:gap-y-0 gap-y-[31px] mt-[clamp(31px,5vw,94px)]'>
                {
                   virtualToRealLifeData?.map((item , index: number) => (
                        <div key={index} className='pt-[clamp(38px,4vw,64px)] px-[clamp(20px,4vw,45px)] pb-10 drop-shadow-md bg-white rounded-4xl w-full'>
                           ...
                           <div>
                            <h1 className='text-[clamp(22px,2.5vw,26px)] font-semibold custom-cunia  mt-[clamp(20px,2.5vw,15px)] uppercase'>{item.title}</h1>
